...
void rmii_ethernet_rt_mac_dual(SERVER_INTERFACE(ethernet_cfg_if, i_cfg[n_cfg]), static_const_unsigned_t n_cfg,
                              ...
                              nullable_streaming_chanend_t c_tx_hp,
                              in_port_t p_clk,
                              port p_rxd_0_0, NULLABLE_RESOURCE(port, p_rxd_1_0), rmii_data_4b_pin_assignment_t rx_pin_map_0,
                              in_port_t p_rxdv_0,
                              out_port_t p_txen_0,
                              port p_txd_0_0, NULLABLE_RESOURCE(port, p_txd_1_0), rmii_data_4b_pin_assignment_t tx_pin_map_0,
                              clock rxclk_0,
                              clock txclk_0,
                              port p_rxd_0_1, NULLABLE_RESOURCE(port, p_rxd_1_1), rmii_data_4b_pin_assignment_t rx_pin_map_1,
                              in_port_t p_rxdv_1,
                              out_port_t p_txen_1,
                              port p_txd_0_1, NULLABLE_RESOURCE(port, p_txd_1_1), rmii_data_4b_pin_assignment_t tx_pin_map_1,
                              clock rxclk_1,
                              clock txclk_1,
                              static_const_unsigned_t rx_bufsize_words,
                              static_const_unsigned_t tx_bufsize_words,
